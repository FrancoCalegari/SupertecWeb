...
document.addEventListener("DOMContentLoaded", async () => {
	...
	try {
		...
		// Nuestro array horarios suele empezar en Lunes (index 0) or Domingo?
		...
		if (isOpen) {
			...
			statusText.innerHTML =
				'<i class="fa-solid fa-store-slash"></i> Cerrado ahora - <a href="https://wa.me/5492615031101" target="_blank">Déjanos un mensaje</a>';
		}
